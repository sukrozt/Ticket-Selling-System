...
def SELLTICKET(i):
    ...
    seats = allinputs[i][4:]                                                #seats: mevcut müşterinin seçmiş olduğu koltuk/lar liste halinde
    therange = []                                                           #therange: çoklu koltuk alımlarında aralıkta alınan tüm koltuk numaraları(1,2)(str)
    multipleseats = []                                                      #multipleseats: çoklu koltuk alımlarında aralıkta alınan tüm koltuklar(c1,c2)(str)
